...
Check Presence Of Oumayma Box In Our Team Page
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/Oumayma_BOX.png
...
Check Presence Of Rania Box In Our Team Page 
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/Rania_BOX.png
...
Check Presence Of Emna Box In Our Team Page
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/Emna_BOX.png
...
Check Presence Of Mohamed Box In Our Team Page
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/Mohamed_BOX.png
...
Check Presence Of Eya Box In Our Team Page
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/Eya_BOX.png
...
Check Presence Of Zoubaida Box In Our Team Page
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/Zoubaida_BOX.png
...
Check Presence Of Chedi Box In Our Team Page
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/Chedi_BOX.png
...
Check Text In Page For Our Team Button
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/SCREENSHOT_OUR_TEAM_BUTTON_TEXT.png
...
Check Text In Page For content Button
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/SCREENSHOT_CONTENT_BUTTON_TEXT.png
...
Check Text In Page For Home Button
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/SCREENSHOT_HOME_BUTTON_TEXT.png
...
Check Text In Page For Discover More Button
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/SCREENSHOT_DISCOVER_MORE_BUTTON_TEXT.png
...
Check Image In Page For Menu Button
    ...
    Capture Page Screenshot     filename=${CURDIR}/results/screenshots_of_testing/SCREENSHOT_MENU_BUTTON_IMAGE_XPATH.png